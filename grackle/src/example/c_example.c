...
int main(int argc, char *argv[])
{
  ...
  *********************************************************************/
  ...
  my_units.length_units = 3.085687e18;
  my_units.time_units = 3.15e13;
  ...
  grackle_data.grackle_data_file = "../../input/CloudyData_noUVB.h5"; // data file
  ...
  for (i = 0;i < field_size;i++) {
    ...
    // solar metallicity
    metal_density[i] = 0;//grackle_data.SolarMetalFractionByMass * density[i];
    ...
    energy[i] = 100000. / temperature_units;
  }
  ...
  *********************************************************************/
  ...
  double time=0;
  while(energy[0]*temperature_units>10)
  {
  if (solve_chemistry(&my_units,
   ...
   time+=dt;
   printf("%g %g\n",time,energy[0]*temperature_units);
  }
